...
import { ChevronLeft, Copy, Share2, AlertCircle, RefreshCw } from 'lucide-react';
...
export default function AartiDetail() {
  ...
  const { narrationState, startNarration, stopNarration, error: ttsError } = useSpeechNarration();
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="sticky top-0 z-10 px-4 py-3 flex items-center gap-3 bg-gradient-to-r from-maroon to-saffron shadow-md">
        ...
        <div className="flex-1 min-w-0">
          <h1 className="text-white font-bold text-base truncate">{aarti.name}</h1>
