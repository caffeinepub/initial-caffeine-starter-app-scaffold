  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: 'radial-gradient(circle at center, oklch(0.85 0.18 60 / 0.25) 0%, oklch(0.65 0.22 40 / 0.1) 40%, transparent 70%)',
      ...
      {[...Array(8)].map((_, i) => (
        <div
          ...
          style={{
            animation: animating ? `petalBurst${i % 4} 2.5s ease-out forwards` : 'none',
      ...
      <div
        ...
        style={{
          animation: animating ? 'lotusEntrance 0.6s cubic-bezier(0.34,1.56,0.64,1) forwards' : 'none',
        }}
      >
        <img
          ...
          style={{
            ...
            animation: animating ? 'lotusRotate 3s ease-in-out infinite' : 'none',
          }}
        />
        <div
        ...
        >
          <p
            ...
            style={{
              ...
              animation: animating ? 'textPulse 1s ease-in-out infinite' : 'none',
            }}
          >
            🕉️ 108 पूर्ण! 🕉️
          </p>
