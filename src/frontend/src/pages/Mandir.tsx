    ...
    <div className="absolute inset-0 flex items-center justify-center pointer-events-none overflow-hidden rounded-2xl">
      ...
      {["ॐ", "🌸", "✨", "🪔", "🌺"].map((symbol, si) => (
        <span
          ...
          style={{
            animation: `omBurst 700ms ease-out ${si * 80}ms both`,
...
export default function Mandir() {
  ...
  const handleOpenMaps = () => {
    window.open(
      "https://www.google.com/maps/search/Hindu+temples+near+me",
      "_blank",
    );
  };
      ...
      <div className="px-4 -mt-4 space-y-4 pb-6">
          ...
          >
            <div className="bg-gradient-to-br from-saffron via-gold/80 to-amber-600 p-5 text-white">
              <div
                ...
                style={{
                  backgroundImage:
                    "url(/assets/generated/mandala-bg-tile.dim_512x512.png)",
        ...
        <div>
          <div className="flex items-center gap-2 mb-3">
            ...
            <h2 className="font-hindi text-lg font-bold text-foreground">
              प्रसिद्ध मंदिर
            </h2>
