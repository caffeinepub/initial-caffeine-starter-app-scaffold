...
const STATIC_CHALISA: ChalisaData[] = [
  {
    ...
    meaning:
      "हनुमान चालीसा में हनुमान जी के गुण, शक्ति और भक्ति का वर्णन है। इसके पाठ से सभी संकट दूर होते हैं।",
    emoji: "🐒",
  },
];
    ...
    <div className="bg-card border border-border rounded-2xl p-4">
      <div className="flex items-start justify-between mb-3">
        ...
        <button
          type="button"
          onClick={() =>
            isSpeaking ? stopNarration() : startNarration(chalisa.fullText)
          }
      ...
      <div
        className={`overflow-hidden transition-all duration-300 ${expanded ? "max-h-[600px] overflow-y-auto" : "max-h-20"}`}
      >
