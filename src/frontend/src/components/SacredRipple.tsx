        ...
        <React.Fragment key={r.id}>
          ...
          <div
            ...
            style={{
              ...
              animation:
                "sacredRipple1 0.8s cubic-bezier(0.2, 0.6, 0.4, 1) forwards",
            }}
          />
          {/* Ring 2 */}
          <div
            ...
            style={{
              ...
              animation:
                "sacredRipple2 0.8s cubic-bezier(0.2, 0.6, 0.4, 1) 0.1s forwards",
            }}
          />
          {/* Ring 3 - subtle outer */}
          <div
            ...
            style={{
              ...
              animation:
                "sacredRipple3 0.8s cubic-bezier(0.2, 0.6, 0.4, 1) 0.2s forwards",
            }}
          />
        </React.Fragment>
      ))}
